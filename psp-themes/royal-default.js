...
let accentColor = "#ffab41";                 // Primary accent color. Must be a valid hex code with leading '#'
let hoverColor = "#ec9e3d";                  // Secondary color used when hovering/clicking buttons. Defaults to accent color.
let backgroundColor = "#1a273d";             // Override theme background color. Leave blank for default.
