...
let accentColor = "#00b4ff";                 // Primary accent color. Must be a valid hex code with leading '#'
let hoverColor = "#059ce3";                  // Secondary color used when hovering/clicking buttons. Defaults to accent color.
let backgroundColor = "#f9e9b9";             // Override theme background color. Leave blank for default.
const googleFontName = "Poppins";            // Must be a valid Google font family url name (fonts.google.com). Will use default if left blank
...
// Hide items
const hideRecurringFee = true;       // Hide recurring fee from Plan Summary section
