...
let accentColor = "#ce8e42";                 // Primary accent color. Must be a valid hex code with leading '#'
let hoverColor = "#cc9e66";                  // Secondary color used when hovering/clicking buttons. Defaults to accent color.
let backgroundColor = "#b8e0de";             // Override theme background color. Leave blank for default.
const googleFontName = "Acme";            // Must be a valid Google font family url name (fonts.google.com). Will use default if left blank
