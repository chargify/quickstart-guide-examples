...
let accentColor = "#1e53a9";                 // Primary accent color. Must be a valid hex code with leading '#'
let hoverColor = "#134fb3";                  // Secondary color used when hovering/clicking buttons. Defaults to accent color.
let backgroundColor = "#9faece";             // Override theme background color. Leave blank for default.
const googleFontName = "Mingzat";            // Must be a valid Google font family url name (fonts.google.com). Will use default if left blank
