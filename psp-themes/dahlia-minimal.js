...
let accentColor = "#7a5eb3";                 // Primary accent color. Must be a valid hex code with leading '#'
let hoverColor = "#604a8d";                  // Secondary color used when hovering/clicking buttons. Defaults to accent color.
let backgroundColor = "#e69a8d";             // Override theme background color. Leave blank for default.
const googleFontName = "Sriracha";            // Must be a valid Google font family url name (fonts.google.com). Will use default if left blank
