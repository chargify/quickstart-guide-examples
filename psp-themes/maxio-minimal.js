...
let accentColor = "#1d8769";                 // Primary accent color. Must be a valid hex code with leading '#'
let hoverColor = "#fe6fff";                  // Secondary color used when hovering/clicking buttons. Defaults to accent color.
let backgroundColor = "#000";             // Override theme background color. Leave blank for default.
const googleFontName = "Familjen Grotesk";            // Must be a valid Google font family url name (fonts.google.com). Will use default if left blank
...
const hideHeader = true;             // Hide the page header/logo
