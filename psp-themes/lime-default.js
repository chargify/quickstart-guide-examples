...
let accentColor = "#222825";                 // Primary accent color. Must be a valid hex code with leading '#'
let hoverColor = "#424d48";                  // Secondary color used when hovering/clicking buttons. Defaults to accent color.
let backgroundColor = "#bddbcd";             // Override theme background color. Leave blank for default.
const googleFontName = "Lato";            // Must be a valid Google font family url name (fonts.google.com). Will use default if left blank
