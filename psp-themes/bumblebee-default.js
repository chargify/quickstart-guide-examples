...
let accentColor = "#000";                 // Primary accent color. Must be a valid hex code with leading '#'
let hoverColor = "#505050";                  // Secondary color used when hovering/clicking buttons. Defaults to accent color.
let backgroundColor = "#f3df4e";             // Override theme background color. Leave blank for default.
const googleFontName = "Koulen";            // Must be a valid Google font family url name (fonts.google.com). Will use default if left blank
