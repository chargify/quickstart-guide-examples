...
let accentColor = "#b8ca1b";                 // Primary accent color. Must be a valid hex code with leading '#'
let hoverColor = "#919f18";                  // Secondary color used when hovering/clicking buttons. Defaults to accent color.
let backgroundColor = "#242a32";             // Override theme background color. Leave blank for default.
const googleFontName = "Serif Display";            // Must be a valid Google font family url name (fonts.google.com). Will use default if left blank
