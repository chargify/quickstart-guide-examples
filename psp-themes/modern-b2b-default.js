...
// Theme options
const darkMode = false;               // Dark theme WIP. Defaults to light theme.
const theme = "default";              // Accepted values: "default" and "minimal". More themes WIP.
let accentColor = "#677CC2";          // Primary accent color. Must be a valid hex code with leading '#'
let hoverColor = "#5771CA";           // Secondary color used when hovering/clicking buttons. Defaults to accent color.
let backgroundColor = "#F8FAF9";      // Override theme background color. Leave blank for default.
const googleFontName = "Heebo";       // Must be a valid Google font family url name (fonts.google.com). Will use default if left blank
// Mark items as required
const requireOrg = true;             // Make customer organization a required field
const requirePhone = true;           // Make customer phone number a required field and accept values that include 10+ digits
...
const textToReplace = ['Configure Your Plan|Additional Seats','Customer Information|Company Information','Email|Business Email *','Organization|Company Name','First Name|Primary Contact First Name *','Last Name|Primary Contact Last Name *','First Name on Account|Cardholder First Name *','Last Name on Account|Cardholder Last Name *','Place My Order|Subscribe and Pay'];      // Separate original/new text with a pipe ('|'). Example: ["Customer Information|Account Info"]
// END CONFIG ============================================================
$(function () {
