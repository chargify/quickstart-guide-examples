...
let accentColor = "#FF385C";                 // Primary accent color. Must be a valid hex code with leading '#'
let hoverColor = "#FF385C";                  // Secondary color used when hovering/clicking buttons. Defaults to accent color.
let backgroundColor = "#ffffff";             // Override theme background color. Leave blank for default.
const googleFontName = "Montserrat";            // Must be a valid Google font family url name (fonts.google.com). Will use default if left blank
...
const textToReplace = ['Place My Order|Pay and Start My Subscription'];             // Separate original/new text with a pipe ('|'). Example: ["Customer Information|Account Info"]
