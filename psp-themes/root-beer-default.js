...
let accentColor = "#816797";                 // Primary accent color. Must be a valid hex code with leading '#'
let hoverColor = "#816797";                  // Secondary color used when hovering/clicking buttons. Defaults to accent color.
let backgroundColor = "#D6D5A8";             // Override theme background color. Leave blank for default.
const googleFontName = "Nato Sans";            // Must be a valid Google font family url name (fonts.google.com). Will use default if left blank
